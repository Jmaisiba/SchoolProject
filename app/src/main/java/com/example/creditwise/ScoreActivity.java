...
public class ScoreActivity extends  AppCompatActivity implements AdapterView.OnItemSelectedListener {
   private AnswerEntry ae = new AnswerEntry(this);
    ...
    private String[] amountOwedHousehold = {"0-5,000Ksh", "5,0001-15,000Ksh", "15,001-30,000Ksh", "30,000+"};
    private CheckBox mortgage, creditCard, autoLoan, creditUnion, paydayLoan;
    private String[] paymentLoans = {"0-5,000Ksh", "5,001-15,000Ksh", "15,001-30,000Ksh", "30,001+"};
    ...
    private String[] salary = {"0-25,000Ksh", "25,001-60,000Ksh", "60,000+"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Credit Score");
        //back button
    ...
    private void saveAnswers(){
        ...
        if(ae.getAnswerByUserId(User.userId) == null){
            ae.addAnswer(answer);
            Toast.makeText(ScoreActivity.this, "Your answers have been saved!", Toast.LENGTH_LONG).show();
        } //else {
           // ae.updateAnswer(answer);
            //Toast.makeText(ScoreActivity.this, "Your answers have been updated!", Toast.LENGTH_LONG).show();
       // }
    ...
    private Spinner newSpinner(Integer spinnerId, String[] items) {
        ...
        ArrayAdapter aa = new ArrayAdapter(ScoreActivity.this, android.R.layout.simple_spinner_dropdown_item, items);
